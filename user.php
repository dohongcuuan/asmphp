    ...
    <ul class="admin-menu">
      ...
      <li>
        ...
        <button class="collapse-btn" aria-expanded="true" aria-label="collapse menu">
          ...
          <span><a href="dangnhap.php">Đăng Xuất</a></span>
        </button>
      </li>
    </ul>
  </nav>
...
<div class="min-h-screen bg-gray-500">
    <div class="p-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <a href="sing_up1.php">Thêm Tài khoản</a>
                    <thead class="bg-blue-500 text-white shadow-lg">
                        <tr>
                            <th class="py-3 px-4 text-left">id </th>                           
                            <th class="py-3 px-4 text-left">tài khoản</th>
                    ...
                    <tbody >
                        ...
                        <tr class="hover:bg-gray-100">
                          ...
                          ?></td>
                            ...
                            <td class="px-4 py-3"><a href="xoa2.php?id_acc=<?php
                          echo $row['id_acc']
                          ?>" >xóa</a></td>
